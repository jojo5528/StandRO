...
static void display_title(void) {
	...
	ShowMessage("" CL_PASS "       " CL_GREEN "              https://facebook.com/appleroplus2                        " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "       " CL_GREEN "              Server rAthena Modifier By Apple                        " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_PASS "     " CL_BOLD "                                                                 " CL_PASS "" CL_CLL "" CL_NORMAL "\n");
